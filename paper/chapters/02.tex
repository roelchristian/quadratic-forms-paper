...
We shall now quickly review the norm-residue symbol introduced by Hilbert in \cite[pp.~286--287]{hilbert1932theorie}. Our treatment shall be mainly cursory as our goal is to use the properties we shall develop here to simplify some of the arguments in our proof of the Hasse-Minkowski theorem, which is the main result of this chapter. The exception is Theorem\,\ref{thm:global-properties-hs} of \S\,\ref{sec:hilbert-reciprocity}, which we prove in detail, primarily because of its utility in the proof of the Hasse-Minkowski theorem. We refer the reader to \cite{serre2012course} for the details of the proofs.
...
\begin{lemma}[``Dirichlet's theorem on arithmetic progressions'']\label{lem:dirichlet}
