...
\begin{proof}
    By the corollary to the Hasse-Minkowski theorem, we need to show that \(\lambda\) is represented in \(\Rationals_{\infty} = \Reals\) and in \(\Rationals_p\) for all prime \(p\).
\end{proof}
